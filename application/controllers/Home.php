	...
	public function index()
	{
		...
		else
        {
            if($this->session->userdata('usertype')==1)
            {
                ...
                // .
                $data['grade']=$this->Grade_model->select_grade();
                $data['transfer']=$this->Transfer_model->select_transfer();
                $data['training']=$this->Training_model->select_training();
                $data['promotion']=$this->Promotion_model->select_promotion();
                $data['family']=$this->Family_model->select_family();
                $data['inquirie']=$this->Inquirie_model->select_inquirie();
                $data['appreciate']=$this->Appreciate_model->select_appreciate();
                //.
