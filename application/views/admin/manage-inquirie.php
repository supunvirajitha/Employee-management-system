                    ...
                    ?>
                        <tr>
                         ...
                         <td><?php echo isset($cnt['employee_num']) ? $cnt['employee_num'] : ''; ?></td>
                          ...
                          <td><img src="<?php echo base_url(); ?>uploads/inquirie/inquiriedoc/<?php echo $cnt['inquiriedoc'] ?>"
                                                class="img-circle" width="50px" alt="User Image"></td>
                          <td>                       
                            <a href="<?php echo base_url(); ?>edit-inquirie/<?php echo $cnt['id']; ?>" class="btn btn-success">Edit</a>
                            <a href="<?php echo base_url(); ?>delete-inquirie/<?php echo $cnt['id']; ?>" class="btn btn-danger">Delete</a>
                          </td>
                        </tr>
                      <?php 
                        $i++;
                      ...
                      ?>                 
                            ...
                            <a href="<?php echo base_url(); ?>inquirie-print">
