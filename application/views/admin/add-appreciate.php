  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="http://localhost/EMS-CI/add-appreciate">Appreciate</a></li>
      ...
      <?php echo validation_errors('<div class="col-md-12">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <form enctype="multipart/form-data" method="post" action="<?php echo site_url('appreciate/insert'); ?>"> 
              <div class="box-body">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <label>Appreciate Note</label>
                    <textarea class="form-control" name="txtappreciatenote"></textarea>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="date" name="txtappreciatedate" class="form-control">
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <label>Appreciate Documents</label>
