...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="http://localhost/EMS-CI/manage-training">Training</a></li>
              ...
              <table id="example1" class="table table-bordered table-striped " >
                ...
                ?>
                    <tr>
                      ...
                      <td><?php echo $cnt['trainingfd']; ?></td>
                      <td><?php echo $cnt['trainingtd']; ?></td>
                      <td><?php echo $cnt['dis']; ?></td>
                      <td>
                        <a href="<?php echo base_url(); ?>edit-training/<?php echo $cnt['id']; ?>" class="btn btn-success">Edit</a>
                        <a href="<?php echo base_url(); ?>delete-training/<?php echo $cnt['id']; ?>" class="btn btn-danger">Delete</a>
                      </td>
                    </tr>
                  <?php 
                    $i++;
                ...
                <!-- Report -->
                            ...
                            <a href="<?php echo base_url(); ?>training-print">
