...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo base_url('manage-training'); ?>">Training</a></li>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-info">
                    ...
                    <!-- /.box-header -->
                    <form role="form" action="<?php echo base_url('training/update'); ?>" method="POST">
                        <div class="box-body">
                      ...
                      <select class="form-control" name="txtttype">
                        ...
                        <option value="Training" <?php echo ($cnt['ttype'] == 'Training') ? 'selected' : ''; ?>>Training</option>
                      ...
                      <select class="form-control" name="txtdepartment_tid">
                        ...
                        <option value="Sub Store" <?php echo ($cnt['sdivision'] == 'Sub Store') ? 'selected' : ''; ?>>Sub Store</option>
                                    ...
                                    <input type="date" name="txttrainingfd" value="<?php echo $cnt['trainingfd']; ?>" class="form-control" placeholder="From">

                                     <label>To</label>
                                     <input type="date" name="txttrainingtd" value="<?php echo $cnt['trainingtd']; ?>" class="form-control" placeholder="To">
