  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="http://localhost/EMS-CI/add-family">Family</a></li>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Add Member <span style="color: red;">*</span></h3>
            </div>
            <!-- /.box-header -->

            <!-- form start -->

            <form enctype="multipart/form-data" method="post" action="<?php echo site_url('family/insert'); ?>"> 
              <div class="box-body">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="date" name="txtbday" class="form-control">
                  </div>
                </div>
