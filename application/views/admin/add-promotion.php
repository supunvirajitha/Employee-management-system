  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="http://localhost/EMS-CI/add-promotion">Promotion</a></li>
      ...
      <?php echo validation_errors('<div class="col-md-12">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- form start -->
            <?php echo form_open('promotion/insert'); ?>
              <div class="box-body">
              ...
              <div class="form-group">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" name="txtdesiduration" class="form-control">
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="date" name="txtdesifd" class="form-control">
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <label>End</label>
                    <input type="date" name="txtdesitd" class="form-control">
                  </div>
                </div>
